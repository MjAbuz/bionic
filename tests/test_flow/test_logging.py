...
def test(builder, log_checker):
    ...
    log_checker.expect(
        # It would be reasonable to log the following line, but our
        # implementation doesn't log tasks that were already complete when we
        # started, and I don't feel like it's worth going out of our way to
        # change that.
    ...
    log_checker.expect(
        ...
        # hash, not its actual value. A little weird, but again probably not worth
